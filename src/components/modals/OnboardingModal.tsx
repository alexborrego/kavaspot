    ...
    <div className="onboarding-overlay">
      <div className="onboarding-modal">
        <div className="onboarding-header">
          ...
          <p style={{ color: '#888', marginBottom: showMap ? '0.5rem' : '1.5rem' }}>
            {showMap ? 'Find bars on the map' : 'Select your favorite bars to get started'}
          </p>
        ...
        {showMap ? (
          <div className="onboarding-map" style={{ flex: 1, minHeight: '400px', overflow: 'hidden' }}>
            <MapTab />
          </div>
        ) : (
